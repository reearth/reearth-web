...
function AppRoutes() {
  const routes = useRoutes([
    ...
    { path: "/settings/workspace/:teamId", element: <WorkspaceSettings /> },
    { path: "/settings/workspace/:teamId/projects", element: <SettingsProjectList /> },
    { path: "/settings/workspace/:teamId/asset", element: <AssetSettings /> },
    { path: "/settings/project/:projectId", element: <ProjectSettings /> },
    { path: "/settings/project/:projectId/public", element: <PublicSettings /> },
    { path: "/settings/project/:projectId/dataset", element: <DatasetSettings /> },
    { path: "/settings/project/:projectId/plugins", element: <PluginSettings /> },
