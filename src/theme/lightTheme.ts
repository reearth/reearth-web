...
const lightheme: Theme = {
  ...
  dashboard: {
    ...
    projectName: colors.light.text.strong,
    projectDescription: colors.light.text.strong,
    publicationStatus: colors.light.text.main,
    memberName: colors.light.text.main,
  },
  buttonPrimary: {
  ...
  projectCell: {
    border: colors.light.brand.main,
    bg: colors.light.bg[2],
