...
export type UI = {
  ...
  readonly show: (
    html: string,
    options?: {
      /** If true, display a iframe. Otherwise, hide the iframe and plugin works like headless mode. Default value is true. */
      visible?: boolean;
  ...
  modal: {
    readonly show: (
      html: string,
      options?: {
        /** If true, display a iframe. Default value is true. */
        visible?: boolean;
        /** Initial iframe width of the modal. If not specified, the iframe will be automatically resized. If a number is specified, it will be treated as pixels. */
        width?: number | string;
        /** Initial iframe height of the modal. If not specified, the iframe will be automatically resized. If a number is specified, it will be treated as pixels. */
        height?: number | string;
      },
    ) => void;
    /**
    ...
    readonly postMessage: (message: any) => void;
    /**
     * Resize the iframe by the modal. If width or height is undefined, it will be auto-resized. If a number is specified, it will be treated as pixels.
     *
     * If modal tries to resize the iframe by specifying size in the iframe's internal HTML, for example, in the body style, or by updating the CSS, iframe will not actually be resized. In that case, plugins need to call this method explicitly to resize the iframe.
     */
    readonly resize: (
      /** Width of the iframe of the modal. */
      width: string | number | undefined,
      /** Height of the iframe of the modal. */
      height: string | number | undefined,
    ) => void;
    readonly close: () => void;
  };
